...
class AutorController extends Controller 
{
	public function Index()
    {
        ...
        $data['query'] = $_GET['q'];
        $data['pag'] = $this->Pagination(array('rows'=>$data['data']['rowspag'],'url'=>'controller=Autor&action=Index','query'=>$_GET['q'],'order'=>$_GET['order']));
		$obj->session($_GET['id']);
	...
	public function create()
    {
		if($_SESSION['insertar']==1)
		{
			...
			$view = new View();
			$view->setData($data);
			$view->setTemplate('view/autor/_frm.php');
			echo $view->renderPartial();
		}
		else
		{
       ...
       public function create_extend()
    {
		if($_SESSION['insertar']==1)
		{
			...
			$view = new View();
			$view->setData($data);
			$view->setTemplate('view/autor/_frm_extend.php');
			echo $view->renderPartial();
		}
		else
		{
    ...
    public function show()
	{
		...
		$data['obj']=$obj;
                $view = new View();
	    $view->setData($data);
	    $view->setTemplate('view/autor/_show.php');
