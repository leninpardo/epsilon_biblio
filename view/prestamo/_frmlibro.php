...
<script type="text/javascript">
	$(function(){
        ...
        //controller="Prestamo_socio";
          $( "#q" ).autocomplete({
   minLength: 0,
   source: "index.php?controller=Prestamo&action=search_libro",
    ...
    select: function( event, ui ) {
			...
			var p=$('#p').val();
                $.ajax({
                    type: "GET",
                    url: "index.php",
                    data: "controller=Prestamo&action=mostrar_libro&q="+q,
...
<div id="frmtotal">
	...
	<table  table width="100%" class='table table-hover table-striped table-bordered' style="border:1px solid #666; font-size:14px; margin-bottom:5px;" align="center">
		...
		<tr style="border-bottom:1px solid #666; background:#F0F0F0;">
			...
			<td align="center"><a href="javascript:devolver_libro('<?php  echo $val[0]; ?>','<?php  echo utf8_encode($val[1]); ?>','<?php  echo utf8_encode($val[2]); ?>','<?php  echo utf8_encode($val[3]); ?>');" title="Buscar Libro"><img src="web/images/accept.png"  border="0"></a></td>
		</tr>
			<?php }?>
	</table>
	<?php echo $pag;?>
