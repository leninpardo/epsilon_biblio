...
<table cellspacing="4" cellpadding="0"   border="0" align="center" >
		  ...
		  <input type="hidden" name="idlibro" id="idlibro" value="<?php echo $obj->idlibro;?>"/>
              ...
              <td ><input type='text' size='11' name='fecha_p' id='fecha_p' value="<?php if($obj){echo validar_fecha($obj->year_edicion);}  ?>"/></td>
           <td >Ultima publicacion:</td>
              <td ><input type='text' size='11' name='fecha_u' id='fecha_u' value="<?php if($obj){echo validar_fecha($obj->year_last_edicion);}  ?>"/></td>
                ...
                <div>
                    <fieldset>
                        ...
                        <div class='span3'>
                            ...
                            <table id='detalle_libro' border="1" class='table table-bordered table-hover table-striped' style=' width:800px;'>
                                <tr>

                                <thead>      
                                <th>nombre autor</th><th>nacionalidad</th></tr>
                            </thead>
                                <tbody id='dt_libro'>
                                    <?php 
                                    if($autores)
                                    {
                                     ...
                                     {
                                         echo "<tr>";
                                         echo "<td><input class='autor_id' type='hidden' name='autor[]' id='autor[]' value='$a[0]' />$a[1]</td>";
                                          echo "<td>$a[2]</td>";
