<script type="text/javascript" src="web/js/evnt/val_frmEditorial.js" ></script>
<div class='breadcrumbs'>Registro de Editoriales</div>
<div id="frmtotal">
	<div id="msg" ></div>
		...
		<table  width="550" cellspacing="4"cellpadding="0" border="0" >
			...
			<tr>
				...
				<td colspan="3"><input name="oper" id="oper" type="hidden" value="<?php echo $p;?>"/>
					<input name="ideditorial" id="idautor" type="hidden" value="<?php echo $obj->ideditorial; ?>"/>
			...
			<tr>
				<td colspan="4" align="center" >
				    <?php if($p==1){?>
 <input type="submit" class="btn btn-small" name="grabar3" id="grabar3" value="Registrar"  />
				    <?php }if($p==2){?><input type="submit" name="grabar3" class="btn btn-small" id="grabar3" value="Actualizar"  />
				    <?php }?>
